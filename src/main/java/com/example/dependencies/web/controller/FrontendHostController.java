...
import com.example.dependencies.dtos.frontendhost.request.*;
import com.example.dependencies.dtos.frontendhost.request.Host;
import com.example.dependencies.dtos.frontendhost.request.Service;
import com.example.dependencies.dtos.frontendhost.response.*;
...
@RestController
@RequestMapping("/api")
public class FrontendHostController {
    ...
    // define a logger
    private Logger logger = LoggerFactory.getLogger(FrontendHostController.class);

    @RequestMapping("/fehost")
